...
#import "CSLAlertEngineDelegate.h"
#import "CSLAlertRootViewControllerDelegate.h"
#import "CSLDNDSource.h"
#import "CSLUIStateProviding.h"
#import "CSLWorkspaceRequestHandling.h"
#import "CUISAlertProviderDelegate.h"

@class CSLAlertClientSoundPolicy, CSLAlertEngine, CSLAlertManagerUpdate, CSLAlertPolicy, CSLAlertRootViewController, CSLAlertWindow, CSLPITimer, FBDisplayLayoutElement, FBScene, NSMutableArray, NSString;

@interface CSLAlertManager : NSObject <CUISAlertProviderDelegate, CSLAlertRootViewControllerDelegate, CSLAlertEngineDelegate, CSLDNDSource, CSLWorkspaceRequestHandling, CSLUIStateProviding>
{

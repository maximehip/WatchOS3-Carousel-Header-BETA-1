...
#import "CSLHexAppGraphDelegate.h"
#import "CSLPressStateApplierDelegate.h"
#import "CSLUIInertialUpdaterDelegate.h"

@class CADisplayLink, CSLHexAppGraph, CSLHexAppNode, CSLHexLayout, CSLIconTapGestureRecognizer, CSLPanGestureRecognizer, CSLPressStateApplier, CSLSSuspendSystemGestureAssertion, CSLUIIconView, CSLUIInertialUpdater, CSLUIPointAnimator, CSLUniformHexLayout, NSMutableDictionary, NSString, NSTimer, UIGestureRecognizer, UIView<CSLUIHexIconView>;
...
@interface CSLUIFieldOfIconsView : UIView <CSLHexAppGraphDelegate, CSLUIInertialUpdaterDelegate, CSLPressStateApplierDelegate>
{
    ...
    // Error parsing type: , name: _offscreenBounds
...
- (void)_invalidateSystemGestureAssertion;
- (void)_handleSystemGestureTimer:(id)arg1;

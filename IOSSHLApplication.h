...
@class BKSProcessAssertion, BSCFBundle, FBApplicationInfo, FBApplicationProcess, FBProcessState, FBSceneSnapshot, FBWindowContextManager, IOSSHLActivationSettings, IOSSHLBackedUpDataStore, IOSSHLPresentationContext, IOSSHLStateSettings, NSArray, NSDate, NSDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet, NSNumber, NSSet, NSString, NSTimer, PCPersistentTimer, PUICApplicationStatusBarItem, UIRemoteApplication, XBApplicationSnapshotManifest;
...
@interface IOSSHLApplication : NSObject <IOSSHLPresentationProtocol>
{
    ...
    FBSceneSnapshot *_cachedSceneSnapshot;
...
- (void).cxx_destruct;
- (id)cachedSceneSnapshot;
- (void)setCachedSceneSnapshot:(id)arg1;
...
- (id)snapshotImage;
- (id)firstValidSnapshotForBundleIdentifier:(id)arg1;
...
- (void)deleteAllSnapshotsWithCompletion:(CDUnknownBlockType)arg1;

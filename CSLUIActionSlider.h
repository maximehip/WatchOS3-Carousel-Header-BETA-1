...
@class NSString, UIBezierPath, UIColor, UIFont, UIImage, UIImageView, UILabel, UIPanGestureRecognizer, UIView, UIView<CSLUIActionSliderLabel>, _UIBackdropView, _UIVibrantSettings;

@interface CSLUIActionSlider : UIControl <UIGestureRecognizerDelegate>
{
    UIView *_contentView;
    ...
    UILabel *_knobLabel;
    UIView<CSLUIActionSliderLabel> *_trackLabel;
    ...
    id <CSLUIActionSliderDelegate> _delegate;
    float _knobWidth;
...
@property(nonatomic) id <CSLUIActionSliderDelegate> delegate; // @synthesize delegate=_delegate;

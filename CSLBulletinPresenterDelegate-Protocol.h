...
@class CUISAlertViewController<CSLBulletinPresenter>, NSDictionary, NSString, NSURL;

@protocol CSLBulletinPresenterDelegate <NSObject>
- (void)scheduleSnapshotForBulletinPresenter:(CUISAlertViewController<CSLBulletinPresenter> *)arg1;

...
@class CSLDeleteModePresentationFractionAnimator, CSLNavigationTransactionAnimatorHelper, CSLPageOffsetAnimator, NSString;

@interface CSLAppSwitcherToAppTransaction : IOSSHLTransaction <CSLNavigationTransactionAnimator>
{
    CSLPageOffsetAnimator *_pageOffsetAnimator;
    CSLDeleteModePresentationFractionAnimator *_deleteModePresentationFractionAnimator;

...
#import "CSLSNotificationCenterServiceServerExportedInterface.h"
#import "NSXPCListenerDelegate.h"

@class NSArray, NSMutableArray, NSString, NSTimer, NSXPCListener;
...
- (void)_restoreToStateLoadSettings:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;
- (void)_reset:(id)arg1;
